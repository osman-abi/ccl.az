jQuery(document).ready(function($) {
    ...
    jQuery('.wm-service-slider').slick({
        ...
        autoplaySpeed: 2000,
        infinite: true,
        prevArrow: "<span class='slick-arrow slick-arrow-left'><i class='flaticon-arrows-1'></i></span>",
        nextArrow: "<span class='slick-arrow slick-arrow-right'><i class='flaticon-arrows-1'></i></span>",
        responsive: [{
                breakpoint: 1024,
                settings: {
                    slidesToShow: 2,
    ...
    jQuery('.wm-banner-nav').slick({
        ...
        dots: false,
        vertical: true,
        prevArrow: "<span class='slick-arrow-left'><img src='images/banner-arrow-1.png' alt=''></span>",
        nextArrow: "<span class='slick-arrow-right'><img src='images/banner-arrow-2.png' alt=''></span>",
        centerMode: true,
        focusOnSelect: true,
        responsive: [{
                breakpoint: 1024,
    ...
    //************************************
    // Testimonial Thumb Slider Function
    //************************************
    ...
    //***************************
    jQuery('.wm-navicons a.fa-search,.wm-search a.fa-search').on("click", function() {
